...
<div class="alert alert-danger">
    <b><?=$this->getTrans('warningBackup', ($this->get('lastBackup')) ? $this->get('lastBackup')->getDate() : $this->getTrans('noBackup')) ?></b>
</div>
        ...
        <table id="sortTable" class="table table-hover table-striped">
            ...
            <?php foreach ($this->get('installedSupportedModules') as $module) : ?>
                <tr class="filter">
                    ...
                    <td><?=(key_exists($module->getKey(), $this->get('convertedModules'))) ? $this->getTrans('converted') : $this->getTrans('notConverted') ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
